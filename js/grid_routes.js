...
let trade_routes = [
	...
	[[[4.77, 31.33], [3.16, 28.14]],"downwind"], //dragon cliffs -> fire fish
	[[[2.73, 28.22], [-4.8682, 31.14]],"beamreach"], //fire fish -> gold rock
];
...
let secret_routes = [
	...
	[[[4.77, 31.33], [5.9867, 33.0134]],"closehauled"], // dragon cliffs -> teapoint
	[[[5.9867, 33.0134], [22.42764, 38.4074]],"downwind"], // teapoint -> chronos
	[[[22.42764, 38.4074], [22.381017, 31.510734]],"closehauled"], // chronos -> dogleg
	[[[22.381017, 31.510734], [4.77, 31.33]],"downwind"], // dogleg  -> dragon cliffs
];
